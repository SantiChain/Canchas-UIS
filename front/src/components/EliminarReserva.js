...
import './Reserva.css'; // Puedes compartir estilos
...
function EliminarReserva() {
  ...
  useEffect(() => {
    ...
    if (codigoGuardado) {
      setCodigoEstudiante(codigoGuardado);
    }
  }, []);
  ...
  return (
    <div className="reserva-container">
      ...
      {showSuccessModal && (
        <div className="modal">
          <div className="modal-content">
            <h3>Reserva eliminada exitosamente</h3>
      ...
      {showErrorModal && (
        <div className="modal">
          <div className="modal-content">
            <h3>No se pudo eliminar la reserva</h3>
      ...
      <form onSubmit={handleDelete}>
        ...
        <input type="text" value={codigoEstudiante} readOnly />
        ...
        <label htmlFor="idHorario">Horario:</label>
        <select
          id="idHorario"
          value={idHorario}
